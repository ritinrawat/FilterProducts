    ...
    <nav className=" w-full backdrop-blur-md bg-gradient-to-br from-gray-50 to-gray-100 border-b border-gray-100 shadow-sm z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          <button className="text-sm font-semibold text-gray-700 hover:text-gray-900 px-1 sm:px-3 py-2 transition-colors">
            Login
          </button>

          <button className="flex items-center gap-2 bg-gray-900 text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
